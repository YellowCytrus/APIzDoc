...
class PageStyles(BaseModel):
    ...
    margin_top: float = Field(25.0, ge=0.0, description="Верхнее поле в mm")
    margin_bottom: float = Field(25.0, ge=0.0, description="Нижнее поле в mm")
    margin_left: float = Field(25.0, ge=0.0, description="Левое поле в mm")
    margin_right: float = Field(25.0, ge=0.0, description="Правое поле в mm")
